...
1. **Check your team**: Call `list_teammates` to see available agents
...
4. **Delegate**: Call `assign_to_teammate(target="<agent-name>", task="<instructions>")`
5. **STOP**: After calling assign_to_teammate, stop your session immediately
